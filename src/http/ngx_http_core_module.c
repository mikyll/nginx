...
static ngx_command_t  ngx_http_core_commands[] = {
    ...
    { ngx_string("decode_percent_characters"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_HTTP_SRV_CONF_OFFSET,
      offsetof(ngx_http_core_srv_conf_t, decode_percent_characters),
      NULL },
...
ngx_http_core_create_srv_conf(ngx_conf_t *cf)
{
    ...
    cscf->decode_percent_characters = NGX_CONF_UNSET;
...
ngx_http_core_merge_srv_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    ngx_conf_merge_value(conf->decode_percent_characters, prev->decode_percent_characters, 1);
